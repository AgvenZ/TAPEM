      ...
      <div class="container mx-auto flex justify-between items-center py-3">
       <div class="flex items-center space-x-6 inconsolata-font">
        <div class="relative">
         ...
         <div class="absolute bg-gray-800 shadow-lg mt-3 group-hover:block dropdown-content min-w-[200px] hidden" id="profilDropdown">
        ...
        <div class="relative">
         ...
         <div class="absolute bg-gray-800 shadow-lg mt-3 dropdown-content min-w-[250px] hidden" id="programDropdown">
          <ul class="py-2 text-sm">
           <li>
        ...
        <div class="relative">
         ...
         <div class="absolute bg-gray-800 shadow-lg mt-3 dropdown-content min-w-[200px] hidden" id="informasiDropdown">
          <ul class="py-2 text-sm">
           <li>
