              ...
              <div class="flex flex-col md:flex-row">
               <div class="md:w-2/3 mx-auto p-4">
                ...
                <h1 class="text-4xl judson-font font-bold text-center">
                    Bagian Tata Pemerintahan Gelar Pembinaan Kelurahan untuk Meningkatkan Kualitas Kinerja, Data & Informasi
                </h1>
                ...
                <div class="carousel mt-4">
                 <div class="carousel-inner">
                  <div class="carousel-item active">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang memberikan pidato" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berjabat tangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7-2.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang bersama tamu undangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7-3.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berfoto bersama" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7-4.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7-5.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita7-6.png" width="600"/>
                  </div>
                 </div>
                ...
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                 ...
                 - Bagian Tata Pemerintahan Sekretariat Daerah Kota Semarang melakukan pembinaan kelurahan di beberapa kelurahan di Kota Semarang. Pembinaan tersebut dilakukan untuk meningkatkan kualitas penyusunan Laporan Evaluasi Kinerja, Penelaahan Rupabumi dan Digitalisasi Informasi kelurahan.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Pembinaan dilakukan oleh Tim dari Bagian Tata Pemerintahan secara langsung ke masing-masing kelurahan. Tim Tapem memberikan pengarahan dan bimbingan kepada perangkat kelurahan tentang cara pengisian laporan evaluasi kinerja, pelaahan rupabumi dan digitalisasi informasi.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    "Pembinaan ini bertujuan untuk memastikan bahwa data dan informasi kelurahan di Kota Semarang akurat dan dapat dipertanggungjawabkan," kata Analis Desa dan Kelurahan Bagian Tata Pemerintahan Kota Semarang, Hanifia Yunastiti, S.I.P.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Pembinaan ini bertujuan untuk memastikan bahwa laporan evaluasi kinerja kelurahan diisi dengan benar dan akurat. Laporan evaluasi kinerja kelurahan digunakan untuk mengukur kinerja kelurahan dalam melaksanakan tugas dan fungsinya.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Sedangkan pembinaan Rupabumi bertujuan untuk meningkatkan pengetahuan dan keterampilan perangkat kelurahan dalam melakukan penelaahan nama rupabumi. Penelaahan nama rupabumi penting untuk memastikan bahwa nama rupabumi di Kota Semarang sesuai dengan aturan dan peraturan yang berlaku.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Untuk digitalisasi informasi bertujuan untuk meningkatkan pengetahuan dan keterampilan perangkat kelurahan dalam menggunakan aplikasi sistem informasi kelurahan. Aplikasi sistem informasi kelurahan digunakan untuk mengelola data dan informasi kelurahan secara digital.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Pembinaan tersebut disambut baik oleh perangkat kelurahan. Mereka berharap pembinaan tersebut dapat meningkatkan pengetahuan dan keterampilan mereka dalam pengisian laporan evaluasi kinerja, pelaahan rupabumi dan digitalisasi informasi.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Pembinaan tersebut akan terus dilakukan oleh Bagian Tata Pemerintahan Kota Semarang. Hal ini untuk memastikan bahwa data dan informasi kelurahan di Kota Semarang selalu akurat dan dapat dipertanggungjawabkan.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Dengan adanya perangkat kelurahan yang kompeten, maka data dan informasi kelurahan di Kota Semarang dapat dikelola dengan baik dan akurat. Hal ini penting untuk mendukung pelayanan publik di Kota Semarang.
                </p>
...
let currentSlide = 0;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            showSlide(currentSlide);// Change slide every 3 seconds
        });
