              ...
              <div class="flex flex-col md:flex-row">
               <div class="md:w-2/3 mx-auto p-4">
                ...
                <h1 class="text-4xl judson-font font-bold text-center">
                    Rapat Sinkronisasi Data Kependudukan: Menuju Administrasi Yang Akurat
                </h1>
                ...
                <div class="carousel mt-4">
                 <div class="carousel-inner">
                  <div class="carousel-item active">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang memberikan pidato" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita3.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berjabat tangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita3-2.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang bersama tamu undangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita3-3.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berfoto bersama" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita3-4.png" width="600"/>
                  </div>
                 </div>
                ...
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                 ...
                 – Dalam rangka meningkatkan akurasi dan kualitas administrasi kependudukan, Pemerintah Kota Semarang melalui Bagian Tata Pemerintahan Sekretariat Daerah mengadakan Rapat Sinkronisasi Data Kependudukan. Rapat yang dihadiri oleh berbagai stakeholder terkait, termasuk instansi pemerintah, bertujuan untuk memastikan integrasi data kependudukan yang lebih efektif dan efisien.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Kegiatan ini juga merupakan upaya untuk memperkuat koordinasi antar instansi dalam rangka memperbarui dan menyempurnakan sistem data kependudukan yang digunakan di Kota Semarang. Diharapkan, hasil dari rapat ini dapat menghasilkan kebijakan yang lebih tepat dan dapat mempercepat pelayanan publik.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Dengan sinergi yang lebih baik antar instansi, diharapkan akan tercipta sistem administrasi kependudukan yang akurat, transparan, dan dapat diandalkan dalam berbagai sektor pembangunan di Kota Semarang.
                </p>
