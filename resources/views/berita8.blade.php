              ...
              <div class="flex flex-col md:flex-row">
               <div class="md:w-2/3 mx-auto p-4">
                ...
                <h1 class="text-4xl judson-font font-bold text-center">
                    Pemerintah Kota Semarang Gelar Rapat Koordinasi Kewaspadaan Wilayah terhadap Bencana Kebakaran
                </h1>
                ...
                <div class="carousel mt-4">
                 <div class="carousel-inner">
                  <div class="carousel-item active">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang memberikan pidato" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8.png" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berjabat tangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-2.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang bersama tamu undangan" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-3.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang berfoto bersama" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-4.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-5.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-6.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-7.jpeg" width="600"/>
                  </div>
                  <div class="carousel-item">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang menandatangani dokumen" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita8-8.jpeg" width="600"/>
                  </div>
                 </div>
                 ...
                 <div class="carousel-indicators">
                  ...
                  <div onclick="goToSlide(6)">
                  </div>
                  <div onclick="goToSlide(7)">
                  </div>
                 </div>
                </div>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                 <i>
                    Semarang, 09 Oktober 2023
                 </i>
                 - Pemerintah Kota Semarang menggelar Rapat Koordinasi Kewaspadaan Wilayah terhadap Bencana Kebakaran pada Senin (09/7) di Situation Room  Balai Kota Semarang. Rapat ini dihadiri oleh Camat dan Lurah se-Kota Semarang, serta perwakilan dari instansi terkait.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Rapat ini diselenggarakan oleh Pemerintah Kota Semarang dalam rangka meningkatkan kewaspadaan terhadap bencana kebakaran, menyusun rencana penanggulangan bencana kebakaran, dan meningkatkan kerja sama antarinstansi terkait.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Dalam sambutannya, Wali Kota Semarang, Hevearita Gunaryanti Rahayu, mengatakan bahwa selama musim kemarau sekaligus dampak El Nino yang terjadi di Kota Semarang telah mengakibatkan beberapa wilayah/lahan kosong/rumput/ilalang kering terbakar. Oleh karena itu, diperlukan upaya untuk meningkatkan kewaspadaan dan kesiapsiagaan terhadap bencana kebakaran.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    "Rapat ini merupakan upaya kita untuk meningkatkan kewaspadaan dan kesiapsiagaan terhadap bencana kebakaran," kata Wali Kota Semarang. "Kita harus bekerja sama untuk mencegah terjadinya bencana kebakaran, dan jika terjadi, kita harus segera melakukan penanganan agar tidak menimbulkan kerugian yang lebih besar."
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Rapat Koordinasi Kewaspadaan Wilayah terhadap Bencana Kebakaran ini merupakan salah satu upaya Pemerintah Kota Semarang untuk meningkatkan kewaspadaan dan kesiapsiagaan terhadap bencana kebakaran di Kota Semarang.
                </p>
