<header class="sticky top-0 z-50 border-b bg-gradient-to-r from-gray-100/80 to-gray-300/80 shadow-lg backdrop-blur-sm transition-all duration-300 ease-in-out">
    <div class="container mx-auto flex justify-between items-center py-4">
        ...
        <div class="hidden md:flex items-center space-x-6 inconsolata-font">
            ...
            <div class="flex flex-col items-center ml-2">
                ...
                <label class="relative inline-flex items-center cursor-pointer mt-2 transform hover:scale-105 transition-transform duration-300">
                    ...
                    <div class="w-12 h-7 bg-gray-400 rounded-full peer peer-focus:ring-2 peer-focus:ring-black-300 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-gradient-to-r peer-checked:from-red-600 peer-checked:to-red-800 shadow-md"></div>
                </label>
            </div>
            @endif
        </div>
        <div class="md:hidden flex items-center space-x-6 inconsolata-font">
            <a class="text-black text-lg relative nav-link overflow-hidden group flex items-center" href="/regulasi">
                <i class="fas fa-gavel mr-1 text-red-600 text-sm group-hover:text-yellow-500 transition-colors duration-300"></i>
                <span class="relative z-10 group-hover:text-red-600 transition-colors duration-300">REGULASI</span>
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-red-600 to-yellow-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </a>
            <span class="text-lg text-gray-400">|</span>
            <a class="text-black text-lg relative nav-link overflow-hidden group flex items-center" href="/kontak">
                <i class="fas fa-envelope mr-1 text-red-600 text-sm group-hover:text-yellow-500 transition-colors duration-300"></i>
                <span class="relative z-10 group-hover:text-red-600 transition-colors duration-300">KONTAK</span>
                <span class="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-red-600 to-yellow-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </a>
            @if(request()->is('/'))
            <div class="flex flex-col items-center">
                <a class="text-black text-lg flex items-center group" href="#">
                    <i class="fas fa-images mr-1 text-red-600 text-sm group-hover:text-yellow-500 transition-colors duration-300"></i>
                    <span class="group-hover:text-red-600 transition-colors duration-300">SLIDESHOW</span>
                </a>
                <label class="relative inline-flex items-center cursor-pointer mt-2 transform hover:scale-105 transition-transform duration-300">
                    <input checked class="sr-only peer no-outline" id="slideshowToggleMobile" onclick="toggleSlideshowMobile()" type="checkbox" />
                    <div class="w-12 h-7 bg-gray-200 rounded-full peer peer-focus:ring-2 peer-focus:ring-red-300 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-6 after:w-6 after:transition-all dark:border-gray-600 peer-checked:bg-gradient-to-r peer-checked:from-red-600 peer-checked:to-red-800 shadow-md"></div>
                </label>
            </div>
            @endif
        </div>
    ...
    <nav class="bg-gradient-to-r from-[#8B0000] to-[#A52A2A] border-t border-b border-gray-300 shadow-md">
        <div class="container mx-auto flex justify-between items-center py-3">
            <div class="flex items-center space-x-8 inconsolata-font">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute bg-[#8] rounded-md shadow-xl mt-3 group-hover:block dropdown-content min-w-[220px] transform opacity-0 scale-95 translate-y-2 group-hover:opacity-100 group-hover:scale-100 group-hover:translate-y-0 transition-all duration-300 ease-in-out z-50 border border-gray-200" id="dropdown_{{ $loop->index }}">
            ...
            <div class="flex items-center space-x-3">
                <div id="realtime-clock" class="mr-4 inconsolata-font text-lg text-white bg-black bg-opacity-40 px-3 py-1 rounded-lg shadow-sm border border-gray-200"></div>
