...
<body class="font-sans" onclick="closeAllDropdowns(event)">
        ...
        <div class="flex items-center justify-center min-h-screen bg-cover bg-center" style="background-image: url('http://localhost/TAPEM/tapem/resources/img/background4.png');">
            <div class="p-35 rounded-lg max-w-6xl text-white">
                ...
                <div class="flex justify-center mb-8">
                    <img alt="Descriptive image related to Kecamatan and Kelurahan" class="mb-8 w-full h-auto transition-zoom" height="1920" src="http://localhost/TAPEM/tapem/resources/img/poster5.png" width="1080"/>
                </div>
    ...
    <table class="min-w-full border-collapse border border-gray-500 text-white">
                ...
                <br>
                <div class="flex justify-center mb-8">
                    <img alt="Descriptive image related to Kecamatan and Kelurahan" class="mb-8 w-full h-auto transition-zoom" height="1920" src="http://localhost/TAPEM/tapem/resources/img/poster6.png" width="1080"/>
                </div>
            </div>
        </div>
    </div>
