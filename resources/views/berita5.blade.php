              ...
              <div class="flex flex-col md:flex-row">
               <div class="md:w-2/3 mx-auto p-4">
                ...
                <h1 class="text-4xl judson-font font-bold text-center">
                    Warga Tegalsari Apresiasi Program Mbak Ita Sapa Warga
                </h1>
                ...
                <div class="carousel mt-4">
                 <div class="carousel-inner">
                  <div class="carousel-item active">
                   <img alt="Wali Kota dan Wakil Wali Kota Semarang sedang memberikan pidato" class="w-full" height="300" src="http://localhost/TAPEM/tapem/resources/img/berita5.png" width="600"/>
                  </div>
                 </div>
                ...
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                 ...
                 - Warga Kelurahan Tegalsari, Kecamatan Candisari, Kota Semarang, mengapresiasi program Mbak Ita Sapa Warga yang diselenggarakan oleh Pemerintah Kota Semarang. Program ini dinilai mampu mendekatkan pemerintah dengan masyarakat dan menyerap aspirasi masyarakat secara langsung.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Program Mbak Ita Sapa Warga sangat bermanfaat bagi masyarakat. Melalui program ini, warga dapat menyampaikan aspirasi dan permasalahan yang dihadapi secara langsung kepada pemerintah. Selain itu program ini telah membantu masyarakat dalam mendapatkan bantuan pemerintah.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Program Mbak Ita Sapa Warga merupakan program yang digagas oleh Wali Kota Semarang, Dr. Ir. Hj. Hevearita Gunaryanti Rahayu, M.Sos. Program ini dilaksanakan secara rutin di seluruh wilayah Kota Semarang.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Dalam program Mbak Ita Sapa Warga, Wali Kota Semarang turun langsung ke lapangan untuk menemui masyarakat. Wali Kota mendengarkan aspirasi masyarakat dan memberikan bantuan kepada masyarakat yang membutuhkan.
                </p>
                <p class="text-2xl inconsolata-font mt-4 text-justify">
                    Pemerintah Kota Semarang berharap program Mbak Ita Sapa Warga dapat terus meningkatkan partisipasi masyarakat dalam pembangunan.
                </p>
