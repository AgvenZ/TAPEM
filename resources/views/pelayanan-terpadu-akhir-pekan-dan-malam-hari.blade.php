...
<body class="font-sans" onclick="closeAllDropdowns(event)">
    ...
    <div class="bg-black text-white">
        <div class="flex justify-between items-center p-4">
            <div class="text-2xl font-bold andika-font ml-20">PELAYANAN TERPADU AKHIR PEKAN DAN MALAM HARI</div>
            <div class="flex items-center space-x-1 inconsolata-font ml-auto mr-12">
                ...
                <div class="flex flex-col">
                    <span>PELAYANAN TERPADU AKHIR</span>
                    <span>PEKAN DAN MALAM HARI</span>
                </div>
            </div>
        </div>
    </div>
    <div class="flex items-center justify-center min-h-screen bg-cover bg-center" style="background-image: url('http://localhost/TAPEM/tapem/resources/img/background4.png');">
        <div class="p-20 rounded-lg max-w-6xl text-white">
            <img alt="Descriptive image related to Kecamatan and Kelurahan" class="mb-8 w-full h-auto transition-zoom" height="1920" src="http://localhost/TAPEM/tapem/resources/img/poster4.png" width="1080"/>
            ...
            <ul class="text-2xl arvo-font mb-8 text-justify list-none pl-6 space-y-4">
                <li>
                    <br>
                    <strong class="andika-font text-3xl">A. Dinas Koperasi dan Usaha Mikro (di 16 Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Pelayanan Konsultasi Pendirian dan Pembinaan Koperasi</li>
                        <li>Pelayanan Konsultasi Pengembangan UMKM (Sosialisasi Pendaftaran Gerai Kopimi, Informasi pemasaran melalui Galeri dan Gulo Asem, Informasi Kredit Wibawa, Informasi HKI, Informasi PIRT, Informasi Halal)</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">B. Badan Pendapatan Daerah (di 16 Kecamatan dan 4 Pos Wilayah):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Klinik Pajak Daerah</li>
                        <li>Pembayaran PBB</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">C. DPMPTSP (di 16 Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Penyiapan Ijin Usaha OSS-RBA, SPP-IRT</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">D. Dinas Kependudukan dan Pencatatan Sipil (di TPDK Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                ...
                <li>
                    <br>
                    <strong class="andika-font text-3xl">E. Dinas Kesehatan (di Puskesmas dan 16 Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                ...
                <li>
                    <br>
                    <strong class="andika-font text-3xl">F. Dinas Kominfo (di 16 Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Dukungan internet untuk pelayanan dan infografis untuk penyebarluasan informasi</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">G. Arsip dan Perpustakaan (di 16 Kecamatan):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Perpustakaan Keliling</li>
                        <li>Pelayanan Disposisi Arsip Keluarga</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">H. Dinas Tenaga Kerja (di Kantor Dinas Tenaga Kerja):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Pelayanan Informasi Tenaga Kerja</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">I. BPN (di Kantor BPN Kota Semarang):</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Pelayanan Informasi Pertanahan (setiap hari Sabtu)</li>
                    </ul>
                </li>
                <li>
                    <br>
                    <strong class="andika-font text-3xl">J. Kecamatan</strong>
                    <ul class="pl-16 text-2xl arvo-font mb-8 text-justify list-disc">
                        <li>Menyiapkan tempat pelayanan</li>
                        <li>Menghadirkan UMK lokal</li>
                        <li>Membuat laporan pelaksanaan kegiatan dikirim ke Bagian Tata Pemerintahan paling lambat 7 (tujuh) hari setelah pelaksanaan kegiatan.</li>
                    </ul>
                </li>
            </ul>
        </div>
