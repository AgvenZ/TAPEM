            ...
            <form action="{{ route('admin.pages.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('parent_page') is-invalid @enderror" id="parent_page" name="parent_page">
                        ...
                        <option value="PROFIL" {{ old('parent_page') == 'PROFIL' ? 'selected' : '' }}>PROFIL</option>
                        <option value="PROGRAM & KEGIATAN" {{ old('parent_page') == 'PROGRAM & KEGIATAN' ? 'selected' : '' }}>PROGRAM & KEGIATAN</option>
                        <option value="INFORMASI & LAYANAN" {{ old('parent_page') == 'INFORMASI & LAYANAN' ? 'selected' : '' }}>INFORMASI & LAYANAN</option>
                    </select>
                    @error('parent_page')
